...
capture_asset "filter-deshadow" 384 480 "$MASTER_DIR/filter-deshadow.png"
...
resize_box "$MASTER_DIR/filter-deshadow.png" 192 240 "$ANDROID_DRAWABLE_DIR/filter_thumbnail_deshadow.png"
...
declare -A IOS_FILTERS=(
  ...
  [FilterDeshadow.imageset]="filter-deshadow.png"
